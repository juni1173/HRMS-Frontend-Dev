                    ...
                    <Table striped responsive >
                        <thead>
                            <tr>
                                ...
                                <th><span style={{fontSize:'x-large'}}>{(((data[0].total_presents + data[0].total_wfh + data[0].total_leaves) / data[0].total_working_days) * 100).toFixed('2') > 100 ? 100 : (((data[0].total_presents + data[0].total_wfh + data[0].total_leaves) / data[0].total_working_days) * 100).toFixed('2')}%</span><br></br><span className='font-small-1 text-secondary'> Including Leaves</span></th>
                            </tr>
                            <tr>
