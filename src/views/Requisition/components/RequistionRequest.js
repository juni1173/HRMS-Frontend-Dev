...
toggleCanvasEnd()    
  ...
  useEffect(() => {
    ...
    const submitForm = async () => {
        ...
        if (requisitionData.position !== '' && requisitionData.replacement_for !== '' && requisitionData.no_of_individuals !== '' && requisitionData.jd_selection !== '') {
  ...
  return (
    <Fragment>
        ...
        {!loading ? (
            ...
            <Col md="6" className="mb-1">
                <Label className="form-label">
               Replacement For <Badge color="light-danger">*</Badge>
                </Label>
                <Select
                    type="text"
