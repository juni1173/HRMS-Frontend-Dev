  ...
  return (
    <Fragment>
        ...
        <div className='content-header' >
          <h5 className='mb-2'>Leave Applcation Requests</h5>
          </div>
        </Col>
        <Col md={3}>
            <Label>
      ...
      {!loading ? (
        <>
          {currentItems && Object.values(currentItems).length > 0 ? (
                    ...
                    <CardBody>
                      ...
                      <CardText>
                        ...
                        <Col xs={4} className='mt-1'>
                          ...
                          {item.request_data.leave_type_title ? item.request_data.leave_type_title : <Badge color='danger'>N/A</Badge>}
                        </Col>
                        <Col xs={4} className='mt-1'>
            ...
            <div className="text-center">No Leave Application Data Found!</div>
          )}
        </>
      ) : (
